...
inherit CometChoixMedecin_PM_P_TK_basic PM_TK

#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic constructor {name descr args} {
 this inherited $name $descr
   this set_GDD_id CometChoixMedecin_PM_P_TK_basic
   set this(top_frame)       ""
...
#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic dispose {} {this inherited}

#___________________________________________________________________________________________________________________________________________
Methodes_set_LC CometChoixMedecin_PM_P_TK_basic [P_L_methodes_set_CometChoixMedecin] {} {}
Methodes_get_LC CometChoixMedecin_PM_P_TK_basic [P_L_methodes_get_CometChoixMedecin] {$this(FC)}

#___________________________________________________________________________________________________________________________________________
Generate_PM_setters CometChoixMedecin_PM_P_TK_basic [P_L_methodes_set_CometChoixMedecin_COMET_RE]

#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic Add_prim_mother {c L_prims {index -1}} {
...
#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic get_or_create_prims {root} {
...
#___________________________________________________________________________________________________________________________________________
#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic set_textual_state {v} {
 if {![winfo exists $this(top_frame)]} {return}
   $this(top_frame).lab_state configure -text $v
}

#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic set_question {l} {
 if {![winfo exists $this(top_frame)]} {return}
   $this(top_frame).lab_question configure -text $l
}

#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic set_L_choices {L} {
 if {![winfo exists $this(top_frame)]} {return}
...
#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic validate {} {}

#___________________________________________________________________________________________________________________________________________
method CometChoixMedecin_PM_P_TK_basic cancel   {} {}

...
# Adding some physical presentations 
 this Add_PM_factories [Generate_factories_for_PM_type [list {CometToolBox_GDD_PM_P_B207_basic Ptf_BIGre} \
                                                       ] $objName]
...
#___________________________________________________________________________________________________________________________________________
proc P_L_methodes_set_CometToolBox_GDD_COMET_RE {} {return [list {set_gdd_proxy {v}} {Update_nodes {}} {Select_node {n}} ]}

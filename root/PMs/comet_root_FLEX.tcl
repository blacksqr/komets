...
method Comet_root_PM_P_FLEX generate_FLEX_stub {strm_name {dec {}}} {
 ...
 append strm "\t" " D.importClass(maClasse);\n"
 append strm "\t" " var ma:maClasse = new maClasse(\"cr_PM_P_FLEX\");\n"
 append strm "\t" " var b:Button = new Button();\n"
 append strm "\t" " b.label=ma.getName();\n"
 append strm "\t" " D.eval(new maClasse(\"coucou\")); \n"

...
#___________________________________________________________________________________________________________________________________________
method PM_BIGre Allow_raising_for_daughters {b} {
	set p [this get_root_for_daughters]
	$p Position_des_fils_changeable $b
}

#___________________________________________________________________________________________________________________________________________
method PM_BIGre Allow_raising_for_descendants {b} {
	this Block_raising_for_daughters $b
	foreach PM [this get_daughters] {
		 $PM Block_raising_for_descendants $b
		}
}

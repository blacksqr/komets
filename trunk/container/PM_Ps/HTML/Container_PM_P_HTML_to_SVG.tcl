...
method Container_PM_P_HTML_to_SVG Render {strm_name {dec {}}} {
 ...
 append strm $dec "<div [this Style_class]>\n"
	...
	append strm $dec "</div>\n"
	# viewBox=\"0 0 640 480\" 
	append strm $dec "<svg id=\"${objName}_canvas\" xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"640\" height=\"$this(canevas_height)\" preserveAspectRatio=\"xMidYMid slice\" style=\"width: 600px; height: 400px; border: solid black; \">\n"
	append strm $dec "<g id=\"${objName}_canvas_g_root\" transform=\"scale(0.5, 0.5) rotate(45)\">\n"	

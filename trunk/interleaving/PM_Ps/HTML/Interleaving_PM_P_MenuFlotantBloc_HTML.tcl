...
inherit Interleaving_PM_P_MenuFlotantBloc_HTML PM_HTML
#___________________________________________________________________________________________________________________________________________
method Interleaving_PM_P_MenuFlotantBloc_HTML constructor {name descr args} {
 this inherited $name $descr
 eval "$objName configure $args"
}
#___________________________________________________________________________________________________________________________________________
method Interleaving_PM_P_MenuFlotantBloc_HTML Render {strm_name {dec {}}} {
...
append strm $dec "  " "  " "  " "  " "  " "  " "  " "  " {<IMG SRC="refresh.gif" Height="12"> Edit}  "\n"
...
#___________________________________________________________________________________________________________________________________________
method Interleaving_PM_P_MenuFlotantBloc_HTML Render_daughters {strm_name {dec {}}} {
 upvar $strm_name rep

...
method Specifyer_PM_P_textArea_FLEX Render {strm_name {dec {}}} {
 ...
 append strm $dec " function textArea_entered_${objName}(${objName}_event:Event):void{ \n"
 append strm $dec " 	FLEX_to_TCL(\"$objName\", \"prim_set_text\", ${objName}.text); \n"
 append strm $dec " } \n \n"
 append strm $dec " var $objName:TextArea = new TextArea(); \n"
 append strm $dec " $objName.addEventListener(Event.CHANGE,textArea_entered_${objName}); \n"

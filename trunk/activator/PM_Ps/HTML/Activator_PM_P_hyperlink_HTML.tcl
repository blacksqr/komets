...
method Activator_PM_P_hyperlink_HTML constructor {name descr args} {
 this inherited $name $descr
   ...
   this Add_MetaData PRIM_STYLE_CLASS [list $objName "LINK" \
                                      ]
...
method Activator_PM_P_hyperlink_HTML Render {strm_name {dec {}}} {
 ...
 append strm $dec <span [this Style_class]> "\n"
	append strm $dec <img { src="Comets/activator/PM_Ps/HTML/load.gif" id="} ${objName}_hyperlink_img {" style="position:absolute; visibility:hidden;" />} "\n"
